...
pub enum CLBlastStatusCode_ {
    ...
    InsufficientMemoryTemp = -2050,
    InvalidBatchCount = -2049,
    InvalidOverrideKernel = -2048,
    MissingOverrideParameter = -2047,
    InvalidLocalMemUsage = -2046,
    NoHalfPrecision = -2045,
    NoDoublePrecision = -2044,
    InvalidVectorScalar = -2043,
    InsufficientMemoryScalar = -2042,
    DatabaseError = -2041,
    UnknownError = -2040,
    UnexpectedError = -2039,
}
